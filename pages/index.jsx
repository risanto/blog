    ...
    return (
        ...
        >
            <section className={"mt-4"}>
                ...
                <p className={"mt-2 relative left-2 pr-2 md:pr-6 inline-block"}>I'm a full stack developer who likes to write about programming, career, and personal development. I just recently started this blog so expect more contents to come!</p>
            </section>
