...
From those I received 19 replies: 5 companies gave me a pre-assessments (such as Hackerrank and take home assignments), 9 invited me for initial interviews, and I rejected 5 intervew/assignment invitations because I didn't have the time to (or the emails just came too late).
...
###### Scroll right to explore the whole data.

The reason why I applied to so many positions was because I was scared of how hard it'd be to find a job during pandemic. In hindsight, I would probably be better off making a more targeted and strategic approach in my job applications instead of focusing too much on quantity.
